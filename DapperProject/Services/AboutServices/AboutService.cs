...
namespace DapperProject.Services.AboutServices
{
    public class AboutService : IAboutService
    {
        ...
        public async Task CreateAboutAsync(CreateAboutDto AboutDto)
        {
            ...
            var query = "insert into About (Title,TopDescription,Property1,Property2,Property3,BottomDescription,ImageUrl) values (@Title,@TopDescription,@Property1,@Property2,@Property3,@BottomDescription,@ImageUrl)";
        ...
        {
            var query = "delete from About where AboutId = @id";
        ...
        {
            var query = "select * from About where AboutId = @id";
            var parametres = new DynamicParameters();
            parametres.Add("@id", id);
            var connection = _dapperContext.CreateConnection();
        ...
        {
            var query = "update About set Title = @Title , TopDescription = @TopDescription,Property1 = @Property1,Property2 = @Property2,Property3=@Property3,BottomDescription=@BottomDescription,ImageUrl=@ImageUrl  where @AboutId = @AboutId";
            var parametres = new DynamicParameters(AboutDto);
            var connection = _dapperContext.CreateConnection();
            await connection.ExecuteAsync(query, parametres);
        }
